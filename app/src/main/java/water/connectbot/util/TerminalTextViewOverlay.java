...
public class TerminalTextViewOverlay extends TextView {
	...
	private class TextSelectionActionModeCallback implements ActionMode.Callback {
		...
		public boolean onCreateActionMode(ActionMode mode, Menu menu) {
			...
			menu.add(0, COPY, 0, water.connectbot.R.string.console_menu_copy)
					.setIcon(water.connectbot.R.drawable.ic_action_copy)
					.setShowAsAction(MenuItem.SHOW_AS_ACTION_WITH_TEXT | MenuItem.SHOW_AS_ACTION_IF_ROOM);
			menu.add(0, PASTE, 1, water.connectbot.R.string.console_menu_paste)
					.setIcon(water.connectbot.R.drawable.ic_action_paste)
					.setShowAsAction(MenuItem.SHOW_AS_ACTION_WITH_TEXT | MenuItem.SHOW_AS_ACTION_IF_ROOM);
