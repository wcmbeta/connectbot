...
import water.connectbot.util.Colors;
import water.connectbot.util.HostDatabase;
import water.connectbot.util.UberColorPickerDialog;
import water.connectbot.util.UberColorPickerDialog.OnColorChangedListener;
