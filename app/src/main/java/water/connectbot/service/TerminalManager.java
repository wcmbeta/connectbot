...
import water.connectbot.data.ColorStorage;
import water.connectbot.data.HostStorage;
...
import water.connectbot.util.ProviderLoader;
import water.connectbot.util.ProviderLoaderListener;
...
public class TerminalManager extends Service implements BridgeDisconnectedListener, OnSharedPreferenceChangeListener, ProviderLoaderListener {
	...
	private void enableMediaPlayer() {
		...
		AssetFileDescriptor file = res.openRawResourceFd(water.connectbot.R.raw.bell);
		try {
