...
import water.connectbot.util.PreferenceConstants;
...
public class StartupTest {
	...
	public void localConnectionDisconnectFromHostList() {
		...
		onView(withId(R.id.list))
				.check(ConnectbotMatchers.hasHolderItem(CoreMatchers.allOf(ConnectbotMatchers.withHostNickname("Local"), ConnectbotMatchers.withConnectedHost())))
				.perform(actionOnHolderItem(
						CoreMatchers.allOf(ConnectbotMatchers.withHostNickname("Local"), ConnectbotMatchers.withConnectedHost()), longClick()));
		...
		onView(withId(R.id.list)).check(ConnectbotMatchers.hasHolderItem(CoreMatchers.allOf(ConnectbotMatchers.withHostNickname("Local"), ConnectbotMatchers.withDisconnectedHost())));
	}
	...
	public void localConnectionCanDelete() {
		...
		onView(withId(R.id.list)).perform(actionOnHolderItem(ConnectbotMatchers.withHostNickname("Local"), longClick()));
	...
	private void changeColor(String hostName, @ColorRes int color, @StringRes int stringForColor) {
		...
		onView(withId(R.id.list)).perform(actionOnHolderItem(ConnectbotMatchers.withHostNickname(hostName), longClick()));
		...
		onView(withId(R.id.list)).check(ConnectbotMatchers.hasHolderItem(ConnectbotMatchers.withColoredText(res.getColor(color))));
	}
	...
	private void startNewLocalConnectionAndGoBack(String name) {
		...
		onView(withId(R.id.console_flip)).perform(closeSoftKeyboard(), pressBack());
		onView(withId(R.id.list)).check(ConnectbotMatchers.hasHolderItem(ConnectbotMatchers.withHostNickname(name)));
	}
	...
	private void startNewLocalConnection(String name) {
		...
		try {
			onView(withId(R.id.list)).perform(actionOnHolderItem(
					ConnectbotMatchers.withHostNickname(name), click()));
